                        ...
                        <div className="flex flex-col lg:flex-row items-center gap-16">
                            ...
                            <div className="lg:w-1/2">
                                ...
                                <h2 className="text-sb-dark text-4xl md:text-5xl font-poppins font-bold uppercase leading-tight mb-8">
                                    SafeBuild Canada – <br /> Building Value, Creating Legacy
                                </h2>
                                <div className="space-y-6 text-gray-600 text-lg leading-relaxed">
                                    <p>At SafeBuild Canada, we are dedicated to excellence in every aspect of property care,
                                        construction, and restoration. With years of expertise and a deep understanding of
                                        property ownership challenges, we deliver solutions that enhance both the value and
                                        functionality of your property.</p>
                                    <p>We are proud to serve the Greater Victoria area with a comprehensive range of services,
                                        from cutting-edge architectural design and complex renovations to routine maintenance
                                        and emergency restorations.</p>
                                </div>
                                {/* Stats Grid */}
                                <div className="grid grid-cols-1 sm:grid-cols-3 gap-8 mt-12 bg-gray-50 p-8 rounded-sm">
                                    <div className="text-center sm:text-left">
                                        <span className="block text-4xl font-bold text-sb-orange mb-1">10</span>
                                        <span className="text-sm font-bold uppercase tracking-widest text-sb-dark">Years <br /> Experience</span>
                                    </div>
                                    <div className="text-center sm:text-left border-y sm:border-y-0 sm:border-x border-gray-200 py-6 sm:py-0 sm:px-8">
                                        <span className="block text-4xl font-bold text-sb-orange mb-1">350</span>
                                        <span className="text-sm font-bold uppercase tracking-widest text-sb-dark">Projects <br /> Completed</span>
                                    </div>
                                    <div className="text-center sm:text-left">
                                        <span className="block text-4xl font-bold text-sb-orange mb-1">20+</span>
                                        <span className="text-sm font-bold uppercase tracking-widest text-sb-dark">Worldwide <br /> Branches</span>
                                    </div>
                                </div>
                            </div>
                            {/* Right Image Collage */}
                            <div className="lg:w-1/2 relative">
                                <div className="absolute -top-10 -left-10 w-96 h-96 bg-sb-red/5 rounded-full border border-sb-red/10 -z-10"></div>
                                <div className="relative z-10 grid grid-cols-2 gap-4">
                                    <img src="assets/steptodown.com688306.webp" alt="Work"
                                        className="rounded-sm shadow-xl w-full h-[400px] object-cover" />
                                    <div className="flex flex-col gap-4">
                                        <img src="assets/steptodown.com584276.webp" alt="Work"
                                            className="rounded-sm shadow-xl w-full h-[192px] object-cover" />
                                        <img src="assets/steptodown.com481843-1.webp" alt="Work"
                                            className="rounded-sm shadow-xl w-full h-[192px] object-cover" />
                                    </div>
                                </div>
                            </div>
