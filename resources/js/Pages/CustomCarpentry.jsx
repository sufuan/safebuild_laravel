...
const servicesList = [
    ...
    { label: 'Custom Carpentry & Cabinetry', href: '/custom-carpentry', active: true },
...
export default function CustomCarpentry() {
    ...
    const serviceSchema = {
        ...
        '@type': 'Service',
        '@id': 'https://safebuild.ca/custom-carpentry#service',
        name: 'Custom Carpentry & Cabinetry',
        serviceType: 'Carpentry & Millwork',
        provider: { '@id': 'https://safebuild.ca/#organization' },
        areaServed: { '@type': 'AdministrativeArea', name: 'Greater Victoria, BC' },
        description: 'Bespoke custom carpentry and custom cabinetry services in Victoria BC. Architectural millwork, finish carpentry, custom shelving & built-ins.'
    };

    return (
        <>
            <SEOHead
                title="Custom Carpentry & Cabinetry Victoria BC"
                description="High-end custom carpentry & cabinetry services in Victoria BC. SafeBuild Canada crafts bespoke woodwork, millwork, built-ins, and architectural finishes."
                canonical="https://safebuild.ca/custom-carpentry"
            ...
            <section className="relative h-[450px] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-20 text-center px-4">
                    <h1 className="text-white text-4xl md:text-6xl font-bold uppercase mb-4 tracking-tight font-poppins">
                        Custom Carpentry And Cabinetry Services
                    </h1>
                    <nav className="flex items-center justify-center gap-2 text-sm font-bold uppercase tracking-widest">
                        ...
                        <span className="text-sb-orange">Custom Carpentry And Cabinetry Services</span>
                    </nav>
                </div>
            </section>
                        ...
                        <div className="lg:w-2/3">
                            ...
                            <div className="mb-8">
                                ...
                                <h2 className="text-sb-dark text-3xl md:text-4xl font-bold leading-tight uppercase font-poppins mb-6">
                                    Expertly handcrafted cabinetry tailored to suit your needed design — Our SafeBuild Canada.
                                </h2>
                            </div>

                            <div className="text-gray-600 leading-relaxed text-base mb-8">
                                <p className="mb-3">Experience tailored craftsmanship with our custom carpentry and cabinetry solutions.</p>
                                <p>Whether you need built-in shelving, intricate wood finishes, or custom furniture, we deliver results that are both elegant and durable.</p>
                            </div>

                            <h3 className="text-2xl font-bold text-sb-dark mb-6 uppercase font-poppins">Custom Carpentry And Cabinetry Services</h3>

                            <div className="space-y-5 text-gray-600 leading-relaxed text-base">
                                <p>Custom carpentry turns ordinary spaces into extraordinary environments. We specialize in designing and crafting cabinetry that seamlessly combines beauty, functionality, and quality, tailored to suit your individual style and needs.</p>
                                <p>Our process begins with understanding your vision. Using top-quality materials and expert techniques, we create cabinets and woodwork that bring timeless elegance to your home or workspace. From intricate detailing to seamless finishes, every piece reflects unparalleled craftsmanship. No matter the project size, we deliver excellence at every step.</p>
                                <p>Elevate your home with custom woodworking that captures your vision. Together, we'll create designs that stand the test of time.</p>
                            </div>
                        </div>
