            ...
            <section className="relative h-[450px] flex items-center justify-center overflow-hidden">
                ...
                <div className="relative z-20 text-center px-4">
                    ...
                    <nav className="flex items-center justify-center gap-2 text-sm font-bold uppercase tracking-widest">
                        ...
                        <span className="text-sb-orange">Property Services & Design</span>
                    </nav>
                </div>
            </section>
                    ...
                    <div className="flex flex-col lg:flex-row gap-16">
                        ...
                        <div className="lg:w-2/3">
                            ...
                            <div className="mb-8">
                                ...
                                <h2 className="text-sb-dark text-3xl md:text-4xl font-bold leading-tight uppercase font-poppins mb-6">
                                    Delivering exceptional property services and inspired design solutions — Our SafeBuild Canada.
                                </h2>
                            </div>

                            <div className="text-gray-600 leading-relaxed text-base mb-8">
                                <p className="mb-3">We provide comprehensive property services, including bespoke design, planning, and development management.</p>
                                <p>Our team ensures every project is handled with professionalism and care, right from planning to handover.</p>
                            </div>

                            <h3 className="text-2xl font-bold text-sb-dark mb-6 uppercase font-poppins">Property Services & Design</h3>

                            <div className="space-y-5 text-gray-600 leading-relaxed text-base">
                                <p>SafeBuild Canada offers a full spectrum of property services designed to meet the diverse needs of our clients. Whether you're developing a new build or upgrading an existing property, our expert team guides you from concept to completion.</p>
                                <p>Our design process begins with understanding your lifestyle and aspirations. We integrate functional layouts with aesthetic appeal, ensuring every space reflects your personality and serves your needs effectively. Our architects and designers work collaboratively to create environments that stand the test of time.</p>
                                <p>With years of experience across residential and commercial sectors, we bring unmatched expertise and dedication to every project. Trust SafeBuild Canada to deliver results that exceed expectations.</p>
                            </div>
                        </div>
                        ...
                        <div className="lg:w-1/3">
                            ...
                            <div className="bg-sb-dark p-8 text-white text-center">
                                ...
                                <p className="text-gray-400 text-sm mb-6">Talk to our property experts today and get a free consultation.</p>
                                <a
